		...
		if ($this->getsVars ==""):
			if ($this->PagesFound>1):
				if ($this->currentPage!=1):
					$result .= "<a href='?page=1' title='".$this->msg_initialPage."'><< </a>&nbsp;&nbsp;&nbsp;&nbsp;";
				endif;
				if ($this->currentPage>1):     		$result .= "<a href='?page=".($previous)."' title='".$this->msg_previousPage."'>".$this->msg_previousPage."</a>&nbsp;&nbsp;"; 	endif;
				if (($this->currentPage < $this->PagesFound) && ($this->PagesFound >= 1)):	$result .= " <a href='?page=".($next)."'  title='".$this->msg_nextPage."'>".$this->msg_nextPage."</a>"; 		endif;
				if (($this->PagesFound>1)&&($this->currentPage!=$this->PagesFound)):				
					$result .=  "&nbsp;&nbsp;&nbsp;&nbsp;<a href='?page=".$this->PagesFound."'  title='".$this->msg_finalPage."' > >></a>";
				endif;
			endif;			
		else:
			if ($this->currentPage!=1):
				$result = "<a href='?page=1&".$this->getsVars."' title='".$this->msg_initialPage."'><< </a>&nbsp;&nbsp;&nbsp;&nbsp;";
			endif;
			if ($this->currentPage>1):  $result .=  "<a href='?page=".($previous)."&".$this->getsVars."' title='".$this->msg_previousPage."'>".$this->msg_previousPage."</a>&nbsp;&nbsp;"; 	endif;
			if (($this->currentPage<$this->PagesFound) && ($this->PagesFound>=1)):	$result .= "<a href='?page=".($next)."&".$this->getsVars."'  title='".$this->msg_nextPage."'>".$this->msg_nextPage."</a>"; 		endif;
			if (($this->PagesFound>1)&&($this->currentPage!=$this->PagesFound)):
    ...
    */
	function getNavigationGroupLinks()
	{
			...
			if ( !(($this->currentPage>= 1)&&($this->currentPage<=10)) ):
				$result  = "<a href='?page=".($begin)."&".$this->getsVars."' title='".$this->msg_previous10Results."'>".$this->msg_previous10Results."</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; 
			endif;
			if ($end <= $this->PagesFound):
				$result .= " <a href='?page=".($end)."&".$this->getsVars."'  title='".$this->msg_next10Results."'>".$this->msg_next10Results."</a>";
			endif;
			return $result;
	}
}
