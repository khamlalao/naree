...
<title>ຂ່າວ  | NAREE : Blending traditional craftsmanship with modern style</title>
...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">ໜ້າຫຼັກ</a>   <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span><a href="news.php">ຂ່າວ</a></span><img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span><?php echo $this->item->subject_la?></span> </div>
...
<?php echo  convTextFromDB(encodeFromDB($this->item->description_la)) ?> 
