...
<title>ປະຫວັດນາຣີ | NAREE : Blending traditional craftsmanship with modern style</title>
<meta name="title" content="ປະຫວັດນາຣີ |  NAREE : Blending traditional craftsmanship with modern style">
...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">ໜ້າຫຼັກ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/><span>ປະຫວັດນາຣີ</span> </div>
      ...
      <div class="box-story-caption"> 
            ...
            <div class="box-story-caption-C">ປະຫວັດຄວາມເປັນມາຂອງຍີ່ຫໍ້ກະເປົາ “ ນາຣີ ”</div>
