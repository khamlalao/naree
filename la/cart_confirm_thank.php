...
$gettmp["invoice_id"] = ($_GET["invoice_id"] != null) ? $_GET["invoice_id"] : null;
$gettmp["msg"] = ($_GET["msg"] != null) ? $_GET["msg"] : null;
...
$invoice_order->load("invoice_id = ? ", array($gettmp['invoice_id']));

$template->decision = $gettmp["msg"];
$template->invoice_order = $invoice_order;
