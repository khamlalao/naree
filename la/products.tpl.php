...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">ໜ້າຫຼັກ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <a href="products.php">ສິນຄ້າ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span><?php echo (($this->category->title_la != NULL)? $this->category->title_la : 'ລວມທຸກແບບ');?></span> </div>
