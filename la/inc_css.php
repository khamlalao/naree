...
<link rel="stylesheet" type="text/css" href="en/css/naree.css">
<link rel="stylesheet" type="text/css" href="../css/responsive.css">
<link rel="stylesheet" type="text/css" href="font-face/stylesheet.css">
<link rel="stylesheet" type="text/css" href="en/css/dropdown.css">
...
<script type="text/javascript">
 	...
 	jQuery(function(){
		...
		jQuery(".dim, #close-cart").click(function(){
			jQuery("#box-cart-app").animate({  right: '-344px'}, 300);
			jQuery(".dim").fadeOut();
