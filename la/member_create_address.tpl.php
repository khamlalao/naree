...
<title>ເພີ່ມທີ່ຢູ່ສົ່ງສິນຄ້າ | NAREE : Blending traditional craftsmanship with modern style</title>
<meta name="title" content="ເພີ່ມທີ່ຢູ່ສົ່ງສິນຄ້າ |  NAREE : Blending traditional craftsmanship with modern style">
...
<meta name="description" content=" ເພີ່ມທີ່ຢູ່ສົ່ງສິນຄ້າ on website naree.co">
...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">ໜ້າຫຼັກ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <a href="member.php">ລູກຄ້າ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span>ເພີ່ມທີ່ຢູ່ສົ່ງສິນຄ້າ</span> </div>
      ...
      <div class="product_model post">
        ...
        <div class="box-member-right ">
          ...
          <div class="box-content">
            ...
            <h1><span>ເພີ່ມທີ່ຢູ່ສົ່ງສິນຄ້າ</span></h1>
            ...
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              ...
              <ul class="form-all">
               ...
               <li>
                ...
                <li>
                  ...
                  <input type="text" name="postcode" id="postcode" class="numberEN" ><BR>* ສຳລັບປະເທດລາວ ກະລຸນາພິມ <span class="numberEN">00000</span> ໃສ່ຊ່ອງລະຫັດໄປສະນີ
              ...
              <ul class="form-all">
                ...
                <li>
                  ...
                  <input type="text" name="contact_no1" id="contact_no1"  class="numberEN">
                ...
                <li>
                  ...
                  <input type="text" name="contact_no2" id="contact_no2" class="numberEN" >
