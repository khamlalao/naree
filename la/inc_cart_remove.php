  ...
  <ul class="cart-right">
    ...
    <li>
      ...
      <div class="cart-right-price">
        <h3 class="txt-price">ລາຄາ: <br><?php if($data['discount'] != ''){?><span><span class="numberEN"><?php echo Lang::getProductOrder($data['pid'],'price','la')?></span> ໂດລາ</span> <span class="special"><span class="numberEN"><?php echo Lang::getProductOrder($data['pid'],'discount','la')?></span> USD</span><?php }else{ ?><span class="numberEN"><?php echo Lang::getProductOrder($data['pid'],'price','la')?></span> ໂດລາ<?php } ?></h3>
