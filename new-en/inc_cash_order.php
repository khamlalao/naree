...
<div class="box-summary">
                	  ...
                	  <ul>
                	    <li>Total <span>  <?php echo number_format($gettmp['totalPay'],2)?> USD<BR><?php echo Lang::eXchangeRate('lak',$gettmp['totalPay'])?> LAK</span><div class="clear"></div></li>

                        <li>Shipping <span>00.00</span><div class="clear"></div></li>

                        <li>Grand Total <span> <?php echo number_format($gettmp['totalPay']+$delivery_fee)?> USD<BR><?php echo Lang::eXchangeRate('lak',$gettmp['totalPay']+$delivery_fee)?> LAK</span> <div class="clear"></div></li>
                    ...
                    <a href="products.php" class="btn-login">Add more products</a>
            	</div>
<?php }else{ ?>
<div class="box-summary">
                	  ...
                	  <ul>
                        ...
                        <li>Shipping  <span><?php $delivery_fee = Lang::DeliveryFee($location_zone->zone,$gettmp['weight_total'])?><?php echo $delivery_fee?> USD<BR><?php echo Lang::eXchangeRate('lak',$delivery_fee)?> LAK</span><div class="clear"></div></li>

                        <li>Grand Total <span> <?php echo number_format($gettmp['totalPay']+$delivery_fee,'2')?> USD<BR><?php echo Lang::eXchangeRate('lak',$gettmp['totalPay']+$delivery_fee)?> LAK</span> <div class="clear"></div></li>
