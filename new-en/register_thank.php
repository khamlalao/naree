...
//      $member->birthday = date("Y-m-d", strtotime($_POST["birth_date"]));
	  ...
	  $gettmp['url'] = "http://".$_SERVER["HTTP_HOST"]."/en/member_login_activate.php?id=".$member->id."&authen=".$gettmp['authen']."&do=Activate";
  ...
  case "update" :
    ...
    if ($member->Replace()) {
      ...
      $mail->Subject = $member->name_th."  ".$member->surname_th."  Register Siamintermart Member ";
      ...
      */
      ...
      $_SESSION["member"]["email"] = ($_POST["email"] == null) ? null : $_POST["email"];
      $_SESSION["member"]["name_th"] = ($_POST["name_th"] == null) ? null : $_POST["name_th"];
      $_SESSION["member"]["name_en"] = ($_POST["name_en"] == null) ? null : $_POST["name_en"];
      $_SESSION["member"]["surname_th"] = ($_POST["surname_th"] == null) ? null : $_POST["surname_th"];
      $_SESSION["member"]["surname_en"] = ($_POST["surname_en"] == null) ? null : $_POST["surname_en"];
