...
<div id="wrapper"> 
  ...
  <div id="Containner"  >
    ...
    <div class="content" > 
      ...
      <div class="nav post"> <a href="index.php" class="home">Home</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span>Promotion</span> </div>
      ...
      <ul class=" promotion-all">
      	<li><a href="promotion-banner.php"><div class="box-cation-promo-app">
        	<div class="box-cation-promo">ALL PROMOTIONS</div>
        ...
        <li><a href="promotion.php"><div class="box-cation-promo-app">
        	<div class="box-cation-promo">DISCOUNT PRODUCTS</div>
