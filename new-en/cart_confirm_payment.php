...
/// NAREE PAYMENT
		...
		$params['bill_to_address_country'] = Lang::getLocationZone($location->location_zone,'locate_code');//"LA"; //"TH";
...
//		$params['bill_to_address_city'] = "Vientiane"; //$location->country;
 ...
 // 		$params['bill_city'] = "Vientiane";
		...
		$gettmp['address1'] = substr($location->address1,0,60);

		$gettmp['address2'] = substr($location->address1,61,120);



		$params['bill_to_address_line1'] = $gettmp['address1']; //$location->address1;

		$params['bill_to_address_line2'] = $gettmp['address2']; //$location->address2;
...
<?php
	  ...
	  $gettmp['url_invoice'] = "https://".$_SERVER["HTTP_HOST"]."/en/review_order_print.php?id=".$gettmp['invoice_id']."&member_id=".$_SESSION['member_id']."&reference_number=".$params['reference_number'];
