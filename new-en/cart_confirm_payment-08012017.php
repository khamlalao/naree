...
<?php
	  ...
	  $gettmp['url_invoice'] = "http://".$_SERVER["HTTP_HOST"]."/en/review_order_print.php?id=".$gettmp['invoice_id']."&member_id=".$_SESSION['member_id']."&reference_number=".$params['reference_number'];
