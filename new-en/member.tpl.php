                   ...
                   <div class="box-login" style="width:100%">
                    ...
                    <p>User Information</p>
                	 ...
                	 <ul class="form-all">
                     	...
                     	<li> <label>Name-Surname </label><input type="text" name="name" id="name" disabled value="<?php echo $this->members->name?>"></li>

                     	<li> <label>E-mail </label><input type="text" name="email" id="email" disabled value="<?php echo $this->members->email?>"></li>
                      ...
                      <tbody>
					   ...
					   <li style="position:relative; margin-bottom:30px;">Gender<br>
                        ...
                        <label style="width:20%; float:left;">  <input name="sex" id="sex" value="male" type="radio"<?php echo (($this->members->sex == 'male') ? ' checked="checked"' : '')?> disabled>Male </label> 

                        <label style="width:30%; float:left;">   <input name="sex" id="sex" value="female" type="radio"<?php echo (($this->members->sex == 'female') ? ' checked="checked"' : '')?> disabled>Female</label>                        <div class="clear"></div>
...
<li><a href="member_edit.php" class="btn-login">Edit Profile</a></li>
