...
<table width="100%"  cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="91%" align="right"><strong>NAREE SHOWROOM & HEAD OFFICE </strong> <br>
      Nongbone Village (Horm 1), Saysettha District, <br>
      Vientiane Capital, Lao PDR. <br>
  <strong>Mobile phone : </strong> +856 20-5930 9333 <strong>E-mail : </strong>naree.laos@gmail.com</td>
    </tr>
</table>
</td>
  </tr>
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td><table width="90%" border="0" cellpadding="2" cellspacing="0">
                <tr>
                  <td width="121"><strong>Shipping Method :</strong></td>
                  <td width="125"><?php echo Lang::ShippingMethod($invoice_order->method_shipping,'en')?></td>
                  <td width="5">&nbsp;</td>
                  <td width="113"><strong>Shipping Status :</strong></td>
                  <td width="146">
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#999999">Details</td>
    ...
    <td width="39%" align="center">  <!--/Name-->
      <div class="cart-name">
        <h2 class="txt-mdel"><?php echo Lang::getProductOrder($data['pid'],'title_la','en')?> <br>
          <span style="font-size:12px"><?php echo Lang::getProductOrder($data['pid'],'code','en')?></span></h2>
        </div>
      <!--//name--> </td>
    <td>  
