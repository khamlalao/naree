	...
	<form action="process.php" onsubmit="check(); return false;" name="captchaform">
		<fieldset>
			<div id="elem">
				...
				<div id="captchaimage"><a href="<?php echo $_SERVER['PHP_SELF']; ?>" onclick="refreshimg(); return false;" title="Click to refresh image"><img src="images/image.php?<?php echo time(); ?>" width="132" height="46" alt="Captcha image" /></a>
					<div id="refreshmsg">If you cannot crack the captcha, click on the image once to reload a new one.</div>
				</div>
				<label for="captcha">Enter the characters as seen on the image above (case insensitive):</label>
				<input type="text" maxlength="6" name="captcha" id="captcha" />
				<div id="captchaerror"></div><br />
