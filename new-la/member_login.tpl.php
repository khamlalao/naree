...
<title>ເຂົ້າລະບົບ | NAREE : Blending traditional craftsmanship with modern style</title>
...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">ໜ້າຫຼັກ</a>   <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span>ເຂົ້າລະບົບ</span> </div>
 ...
 Connect with facebook</a>
               ...
               <form action="" name="formL" id="formL" method="post" style="margin:0">
                	 ...
                	 <ul class="form-all">
                     	...
                     	<li> <label>ອີເມລ</label><input type="text" name="username" id="username" value="<?php echo  ($_COOKIE['username'] != null) ? $_COOKIE['username'] : '' ?>" /></li>



                        <li> <label>ລະຫັດຜ່ານ</label>
                  ...
                  <input type="text" name="pwd" id="pwd" onkeydown="dynamicElm()" /><input name="MM_action" type="hidden" id="MM_action" value="login" /></li>
                    ...
                    <?php endif; ?>
                        ...
                        <li><input type="submit" class="btn-login" value="ເຂົ້າລະບົບ" onClick="return checkForm('login')" ></li>
