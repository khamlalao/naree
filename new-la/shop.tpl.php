...
<title>ຮ້ານຄ້າ | ຕົວແທນຈໍາໜ່າຍໃນ ນະຄອນຫຼວງວຽງຈັນ ແລະ ຕ່າງແຂວງ</title>
<meta name="title" content="ຮ້ານຄ້າ | ຕົວແທນຈໍາໜ່າຍໃນ ນະຄອນຫຼວງວຽງຈັນ ແລະ ຕ່າງແຂວງ">
...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">ໜ້າຫຼັກ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span>ຮ້ານຄ້າ</span> </div>
      ...
      <div class="product_model post">
        ...
        <div class=" box-content">
          ...
          <h1><span>ຕົວແທນຈໍາໜ່າຍໃນ ນະຄອນຫຼວງວຽງຈັນ ແລະ ຕ່າງແຂວງ</span></h1>
          ...
          <?php $i++; ?>
            ...
            <li class="post shop-list-w">
              ...
              <div class="box-news"> 
                ...
                <div class="date"><?php echo $val['title_la']?></div>

                <p class="topic-shop"><?php echo $val['address_la']?></p>
