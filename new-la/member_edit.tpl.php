...
<meta name="title" content=" ລາຍລະອຽດບັນຊີ |  NAREE : Blending traditional craftsmanship with modern style">
...
<meta name="description" content=" ລາຍລະອຽດບັນຊີ on website naree.co">
                   ...
                   <div class="box-login" style="width:100%">
                    ...
                    <p>ຂໍ້ມູນລູກຄ້າ</p>
                	 ...
                	 <ul class="form-all">
                     	...
                     	<li> <label>ຊື່ - ນາມສະກຸນ </label><input type="text" name="name" id="name" value="<?php echo $this->members->name?>"></li>

                     	<li> <label>ອີເມລ </label><input type="text" name="email" id="email" value="<?php echo $this->members->email?>"></li>
                      ...
                      <tbody>
                        <tr>
                          <td style="padding-right:8px" class="numberEN"><?php echo list_day('bd_date','bd_date',$this->bd_date,$class,$condition);?></td>
                          <td  style="padding-right:8px"  class="select-m"><?php echo list_month('bd_month','bd_month',$this->bd_month,$class,$condition,'en')?></td>
                          <td  class="numberEN"><?php echo list_year('bd_year','bd_year',$this->bd_year,$class,$condition,'en')?></td>
                        </tr>
                      </tbody>
                    </table>
					   ...
					   <li style="position:relative; margin-bottom:30px;">ເພດ<br>
                        ...
                        <label style="width:20%; float:left;">  <input name="sex" id="sex" value="male" type="radio"<?php echo (($this->members->sex == 'male') ? ' checked="checked"' : '')?>>ຊາຍ </label> 

                        <label style="width:30%; float:left;">   <input name="sex" id="sex" value="female" type="radio"<?php echo (($this->members->sex == 'female') ? ' checked="checked"' : '')?>>ຍິງ</label>                        <div class="clear"></div>

                       </li>

                        

                        <!--<li><input type="button" class="btn-login" value="ບັນທຶກຂໍ້ມູນບັນຊີ" onClick="return checkForm('profile')"></li> -->
                	 ...
                	 <ul class="form-all">
                        ...
                        <li> <label>ລະຫັດຜ່ານເກົ່າ </label><input type="password" name="passwd_old" id="passwd_old"></li>

                         <li> <label>ລະຫັດຜ່ານໃຫມ່  </label><input type="password" name="passwd_new" id="passwd_new"></li>

                       <li> <label>ຢືນຢັນລະຫັດຜ່ານ </label><input type="password" name="passwd_re" id="passwd_re">

                             

                          <span style="font-size:12px;">[ຢ່າງຫນ້ອຍ <span  class="numberEN">6</span> ຕົວຫນັງສື ເຊິ່ງຈະຕ້ອງມີ <span  class="numberEN">1</span> ຕົວເລກ ແລະ <span  class="numberEN">1</span> ຕົວອັກສອນ]</span>
