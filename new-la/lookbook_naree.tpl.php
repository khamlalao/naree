...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">ໜ້າຫຼັກ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <a href="lookbook.php">ແບບຢ່າງກະເປົາ</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span><?php echo $this->category->title_la?> <?php echo $this->category->subject_la?></span> </div>
      ...
      <div class="product_model post">
   		...
   		<h1 class="txt-lookbook">" <?php echo $this->category->title_la?> " <?php echo $this->category->subject_la?></h1>
