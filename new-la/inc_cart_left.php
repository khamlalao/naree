    ...
    <li>
      ...
      <div class="cart-right-img"> <a href="products_detail.php?id=<?php echo $data['pid']?>"><img src="../img_product/<?php echo Lang::getProductOrder($data['pid'],'image','la')?>" alt=""/></a>
        ...
        <div class="cart-right-name">
          ...
          <h2 class="txt-mdel"><a href="products_detail.php?id=<?php echo $data['pid']?>"><?php echo Lang::getProductOrder($data['pid'],'title_la','la')?></a> <span class="numberEN"><?php echo Lang::getProductOrder($data['pid'],'code','la')?></span></h2>
      ...
      <div class="cart-right-price">
        ...
        <h3 class="txt-price">ລາຄາ: <br><?php if($data['discount'] != ''){?><span><span class="numberEN"><?php echo Lang::getProductOrder($data['pid'],'price','en')?></span> ໂດລາ</span> <span class="special"><span class="numberEN"><?php echo Lang::getProductOrder($data['pid'],'discount','en')?></span> ໂດລາ</span><?php }else{ ?><span class="numberEN"><?php echo Lang::getProductOrder($data['pid'],'price','en')?></span> ໂດລາ<?php } ?></h3>
...
<?php if($gettmp["recordCount"] > 0){ ?>
  ...
  <tr>
    <td>ຍອດລວມ</td>
    <td align="right"><span id="cashAmount"><span class="numberEN"><?php echo number_format($gettmp['totalPay'],2)?></span></span> ໂດລາ</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><span id="cashAmount_KIP"><span class="numberEN"><?php echo Lang::eXchangeRate('lak',$gettmp['totalPay'])?></span></span> ກີບ</td>
  </tr>
    </table>
</div>
