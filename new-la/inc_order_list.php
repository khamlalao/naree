        ...
        <?php $i++; ?> 
              <li> 
                ...
                <div class="cart-price">
                  <h3 class="txt-price">ລາຄາ: <span class="numberEN"><?php echo ($data['discount'] != '') ? $data['discount'] : $data['unit_price'] ?></span> ໂດລາ</h3>
                </div>
                <!--//Price--> 
                
                <!--Price-->
                <div class="cart-price">
                  <h3 class="txt-price">ຈ/ນ: <span class="numberEN"><?php echo $data['amount']?></span> ຫນ່ວຍ</h3>
                </div>
                <!--//Price--> 
