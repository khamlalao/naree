...
if($_POST['req_locale'] == 'en'){ $gettmp['locate'] = 'en'; }else{ $gettmp['locate'] = 'la';   }
	  ...
	  $gettmp['url_invoice'] = "http://".$_SERVER["HTTP_HOST"]."/".$gettmp['locate']."/review_order_print.php?id=".$invoice_order->invoice_id."&member_id=".$_SESSION['member_id']."&reference_number=".$invoice_order->req_reference_number;
...
if($_POST['req_locale'] == 'en'){
  ...
  echo "<meta http-equiv=\"refresh\" content=\"0;URL=en/cart_confirm_thank.php?msg=".$_POST['decision']."&invoice_id=".$_POST['req_merchant_secure_data3']."\" />";

} else {

  echo "<meta http-equiv=\"refresh\" content=\"0;URL=la/cart_confirm_thank.php?msg=".$_POST['decision']."&invoice_id=".$_POST['req_merchant_secure_data3']."\" />";
