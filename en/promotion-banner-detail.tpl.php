...
<title><?php echo $this->item->subject_en?></title>
<meta name="title" content="<?php echo $this->item->subject_en?>">
...
<!--<meta name="description" content="<//?=$this->item->description_en?>">
-->
<meta property="og:title" content="<?php echo $this->item->subject_en?>" />
<!--<meta property="og:description" content="<//?=$this->item->description_en?>" />
--><meta property="og:image" content="http://naree.co/img_promotion/banner/<?php echo $this->item->image?>" />
<meta property="og:url" content="http://naree.co/en/promotion-banner-detail.php?id=<?php echo $this->id?>" />
...
<div id="wrapper"> 
  ...
  <div id="Containner"  >
    ...
    <div class="content" style="min-height:500px;"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">Home</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <a href="promotion-all.php">Promotion</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span>All Promotions</span> </div>
...
<?php echo $this->item->description_en?>
...
<div class="news-btn">
                  ...
                  <?php if($this->item->file_doc != null){?>
                   ...
                   <?php } ?>
                    ...
                    <li class="promo-btn"><a href="javascript:popup('https://www.facebook.com/sharer.php?u=http://naree.co/en/promotion-banner-detail.php?id=<?php echo $this->id?>','',500,400)"><img src="images/icon-share.jpg" alt=""/> Share Facebook</a></li>
