...
<div id="wrapper"> 
  ...
  <div id="Containner">
    ...
    <div class="content"> 
      ...
      <div class="nav post"> <a href="index.php" class="home">Home</a> <img src="images/icon/i_av.png" width="20" height="12"  alt=""/> <span>Look Book</span> </div>
       ...
       <?php $i++; ?> 
          ...
          <a href="lookbook_naree.php?parent_id=<?php echo $val['id']?>">
            ...
            <div class="caption<?php echo (($i%2 == 1) ? ' left' : '')?>">
              ...
              <div class="txt-w"> " <?php echo $val['title_en']?> " <br><?php echo $val['subject_en']?></div>
