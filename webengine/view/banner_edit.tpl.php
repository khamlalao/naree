...
function checkForm(){
  with(document.form1){
	<?php if($this->item->file_name_la == null){?>
...
<div class="tabbable">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>&nbsp;</td>
    <td><?php if ($this->item->file_name_la != null) { ?>
    <a href="../../img_banner/<?php echo  $this->item->file_name_la ?>" target="_blank"> <img src="../../img_banner/thumbnail/<?php echo  $this->item->file_name_la ?>"> </a><br /><br />
	<?php } // if ?>
  ...
  <tr>
   ...
   <tr>
    ...
    <td>&nbsp;</td>
    <td><?php if ($this->item->file_name_en != null) { ?>
    <a href="../../img_banner/<?php echo  $this->item->file_name_en ?>" target="_blank"> <img src="../../img_banner/thumbnail/<?php echo  $this->item->file_name_en ?>"></a><br /><BR>
	<?php } // if ?>
