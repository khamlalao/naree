...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="0%">&nbsp;</td>
    <td width="86%"><input type="text" id="sequence" name="sequence" value="<?php echo  ($this->item->sequence != null) ? $this->item->sequence : '' ?>" class="col-xs-6" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
