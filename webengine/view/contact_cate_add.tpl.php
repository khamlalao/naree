...
function checkForm(){
  with(document.form1){
	if (document.getElementById('title_th').value == '') {	
      alert(' กรุณา ระบุชื่อแบบฟอร์มติดต่อ:');
    ...
    SetAction('contact_cate_action.php');
    //return true;
  }
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="14%">Title (TH) &nbsp;: </td>
    <td width="0%">&nbsp;</td>
    <td width="86%"><input type="text" id="title_th" name="title_th" value="<?php echo  ($this->item->title_th != null) ? $this->item->title_th : '' ?>" placeholder="Title" class="col-xs-6" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td width="14%">Email TO &nbsp;: </td>
    <td width="0%">&nbsp;</td>
    <td width="86%"><input type="text" id="email" name="email" value="<?php echo  ($this->item->email != null) ? $this->item->email : '' ?>" placeholder="yourmail@naree.co" class="col-xs-6" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>Email BCC &nbsp;: </td>
    <td>&nbsp;</td>
    <td><input type="text" id="email_bcc" name="email_bcc" value="<?php echo  ($this->item->email_bcc != null) ? $this->item->email_bcc : '' ?>" placeholder="yourmail@naree.co" class="col-xs-6" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
