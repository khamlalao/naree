  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('shop_edit.php?mn=2&id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction("shop_action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction('shop_action.php?do=listupdate');   
      }     
    } 
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td><?php echo  ($val['title_en'] != null) ? $val['title_en'] : '' ?></td>
														<td><?php echo  ($val['title_la'] != null) ? $val['title_la'] : '' ?></td>
														<td align="center">
                                                        <?php echo  ($val['phone'] != null) ? $val['phone'] : '' ?></td>
														<td align="center">&nbsp;</td>
														<td align="center">&nbsp;</td>
													  ...
													  <td><?php echo Lang::getStatus($val['status'])?></td>
														...
														<td align="center">
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="shop_edit.php?id=<?php echo  $val['id'] ?>&mn=11&menu=U2hvcCBNYW5hZ2VtZW50">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																  <a class="red" href="shop_action.php?id=<?php echo  $val['id'] ?>&do=delete&mn=11&menu=U2hvcCBNYW5hZ2VtZW50" onClick="javascript:return confirm('Are you sure you want to delete this item ?')"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
															</div>
														</td>
													</tr>
  <?php } // foreach ?>
<?php } // if ?>
                          <!-- END LOOP -->
                                            ...
                                            <BR>
                                            <button class="btn btn-sm btn-success" type="button" onclick="location.href='shop_add.php?mn=11&menu=U2hvcCBNYW5hZ2VtZW50'">
