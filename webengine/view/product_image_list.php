...
$sql = "SELECT *  FROM product_galleries m WHERE 1 = 1   AND m.parent_id = ? ORDER BY m.sequence ASC";
$stmt = $db->Prepare($sql);
...
$product_item->load("id = ? ", array($gettmp["parent_id"]));
$template->product_item = $product_item;
