  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('banner_edit.php?mn=2&id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction("banner_action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction('banner_action.php?do=listupdate');   
      }     
    } 
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="25%">Title (LAO)</th>
                                                        <th width="25%">URL (LAO)</th>
														<th width="20%">IMG</th>
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td><?php echo  ($val['title_la'] != null) ? $val['title_la'] : '' ?></td>
														<td><?php echo  ($val['url_la'] != null) ? $val['url_la'] : '' ?></td>
														<td align="center"><a href="../../img_banner/<?php echo $val['file_name_la']?>" target="_blank"><img src="../../img_banner/thumbnail/<?php echo $val['file_name_la']?>" alt=""/></a><BR><BR><a href="../../img_banner/<?php echo $val['file_name_en']?>" target="_blank"><img src="../../img_banner/thumbnail/<?php echo $val['file_name_en']?>" alt=""/></a></td>
													  ...
													  <td><?php echo  ($val['update_date'] != null) ? $val['update_date'] : '' ?></td>

														<td><?php echo Lang::getStatus($val['status'])?></td>

														<td align="center">
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="banner_edit.php?id=<?php echo  $val['id'] ?>&mn=2">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																  <a class="red" href="banner_action.php?id=<?php echo  $val['id'] ?>&do=delete&mn=2" onClick="javascript:return confirm('Are you sure you want to delete this item ?')"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
															</div>
														</td>
													</tr>
  <?php } // foreach ?>
<?php } // if ?>
                          <!-- END LOOP -->
                                            ...
                                            <BR>
                                            <button class="btn btn-sm btn-success" type="button" onclick="location.href='banner_add.php?mn=2&menu=QmFubmVyIE1hbmFnZW1lbnQ'">
