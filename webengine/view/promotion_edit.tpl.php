...
function checkForm(){
  with(document.form1){
		if ((document.getElementById('subject_la').value == '')&&(document.getElementById('subject_en').value == '')) {	
      alert(' กรุณากรอก Title :');
      document.getElementById('subject_la').focus();
      return false;
    }	
	$('#description_la').val($('#editor1').html());
	$('#description_en').val($('#editor2').html());		
    SetAction('promotion_action.php');
    //return true;
  }
}
...
function SetAction(url) {
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
                        <form class="form-horizontal" role="form" name="form1" id="form1" method="post" enctype="multipart/form-data" action="promotion_action.php">
                        <div class="tabbable">
                        <ul class="nav nav-tabs" id="myTab">
											...
											<div class="tab-content">
												<div id="thai" class="tab-pane fade in active">
                                                    ...
                                                    <h3 class="header smaller lighter blue">Promotion (LAO)</h3>
                                        <BR>
 ...
 <!-- <tr>
    ...
    <td width="0%">&nbsp;</td>
    <td width="86%"><input type="text" id="title_la" name="title_la" value="< ?= ($this->item->title_la != null) ? $this->item->title_la : '' ?>" placeholder="Title" class="col-xs-6" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>Display Date &nbsp;: </td>
    <td>&nbsp;</td>
    <td><input type="text" id="date_show" name="date_show" value="< ?= ($this->item->date_show != null) ? $this->item->date_show : '' ?>" placeholder="Display Date" class="col-xs-6" /> (Ex. 12-15.09.2016)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><div class="wysiwyg-editor" id="editor1"><?php echo  ($this->item->description_la != null) ? $this->item->description_la : '' ?></div><input type="hidden" name="description_la" id="description_la"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><?php if ($this->item->image != null) { ?>
        <a href="../../img_promotion/banner/<?php echo $this->item->image?>" target="_blank"><img src="../../img_promotion/banner/<?php echo $this->item->image?>" width="200" /></a><br />
        <a href="promotion_action.php?do=delete_thumb&id=<?php echo $this->item->id?>"><img src="../assets/img/clear.png" width="13" height="13"></a><br />
        <?php } // if ?>
  ...
  <tr>
    ...
    <tr>
      ...
      <td><?php if ($this->item->file_doc != null) { ?>
        <a href="../../img_promotion/document/<?php echo $this->item->file_doc?>" target="_blank"><?php echo $this->item->file_doc?></a><br />
        <a href="promotion_action.php?do=delete_file&id=<?php echo $this->item->id?>"><img src="../assets/img/clear.png" width="13" height="13"></a><br />
        <?php } // if ?>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
												 ...
												 <h3 class="header smaller lighter blue">Promotion (EN)</h3>
                                        <BR>
										<!-- <div class="dataTables_borderWrap"> -->
										<div style="background-color:#FFF">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
 <!-- <tr>
    ...
    <td width="0%">&nbsp;</td>
    <td width="86%"><input type="text" id="title_en" name="title_en" value="< ?= ($this->item->title_en != null) ? $this->item->title_en : '' ?>" placeholder="Title" class="col-xs-6" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><div class="wysiwyg-editor" id="editor2"><?php echo  ($this->item->description_en != null) ? $this->item->description_en : '' ?></div><input type="hidden" name="description_en" id="description_en"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
                                        ...
                                        <input type="hidden" id="do" name="do" value="update" />
											...
											&nbsp; &nbsp; &nbsp;
											<button class="btn" type="button" onclick="location.href='promotion_list.php?mn=13&sub=2'">
