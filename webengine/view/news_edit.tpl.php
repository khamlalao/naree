...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><?php if ($this->item->image != null) { ?>
        <a href="../../img_news/large/<?php echo $this->item->image?>" target="_blank"><img src="../../img_news/<?php echo $this->item->image?>" /></a><br />
        <a href="news_action.php?do=delete_thumb&id=<?php echo $this->item->id?>"><img src="../assets/img/clear.png" width="13" height="13"></a><br />
        <?php } // if ?>
  ...
  <tr>
    ...
    <tr>
      ...
      <td><?php if ($this->item->file_doc != null) { ?>
        <a href="../../img_news/document/<?php echo $this->item->file_doc?>" target="_blank"><?php echo $this->item->file_doc?></a><br />
        <a href="news_action.php?do=delete_file&id=<?php echo $this->item->id?>"><img src="../assets/img/clear.png" width="13" height="13"></a><br />
        <?php } // if ?>
