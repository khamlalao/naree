...
<form name="form1" id="form1" method="post" enctype="multipart/form-data" action="exchange_rate.php">
	<div class="tabbable">
											<div class="tab-content">
												<div id="thai" class="tab-pane fade in active">
													<!--<p>Raw denim you probably haven't heard of them jean shorts Austin.</p> -->
                                                    <h3 class="header smaller lighter blue">Exchange Rate</h3>
                                        <BR>
												...
												<div class="widget-main no-padding">
													<table class="table table-striped table-bordered table-hover">
														<thead class="thin-border-bottom">
															<tr>
															  <th>&nbsp;</th>
																<th><i class="ace-icon fa fa-money"></i>USD</th>
																<th><i class="ace-icon fa fa-money"></i>LAK</th>
																<th class="hidden-480">UPDATE</th>
															</tr>
														</thead>
														<tbody>
									<tr>
									<td class="">&nbsp;<input type="hidden" name="id" id="id" value="<?php echo $this->item->id?>" /></td>
									<td class="">1 USD.</td>	
                                   <td align="center">
                                   <input class="input-large" type="text" name="lak" id="lak" value="<?php echo $this->item->lak?>"/></td>
									<td align="center"><?php echo $this->item->created_date?></td>
									</tr>
                                    </tbody>
													</table>
												</div>
