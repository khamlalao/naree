				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><?php echo urlsafe_b64decode($_REQUEST['menu'])?></li>
						</ul><!-- /.breadcrumb -->
...
function checkForm(){
  with(document.form1){
    ...
    SetAction('news_image_action.php');
    //return true;
  }
}
...
<div class="tabbable">
											<div class="tab-content">
												<div id="thai" class="tab-pane fade in active">
                                                    ...
                                                    <h3 class="header smaller lighter blue">Gallery News </h3>
                                        <BR>
  ...
  <tr>
    ...
    <a href="../../img_news_gallery/<?php echo  $this->item->file_name ?>" target="_blank"> <img src="../../img_news_gallery/gallery/<?php echo  $this->item->file_name ?>"> </a><br /><br />
	<?php } // if ?>
