  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('product_edit.php?mn=2&id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction("product_action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction('product_action.php?do=listupdate');   
      }     
    } 
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td><?php echo  ($val['title_la'] != null) ? $val['title_la'] : '' ?><BR><?php echo  ($val['size_la'] != null) ? $val['size_la'] : '' ?></td>
														<td><?php echo  ($val['title_en'] != null) ? $val['title_en'] : '' ?><BR><?php echo  ($val['size_en'] != null) ? $val['size_en'] : '' ?></td>
														<td><img src="../../img_product/<?php echo $val['image']?>" alt="" width="80"/>
                                                        <a href="product_image_list.php?mn=6&sub=1&parent_id=<?php echo $val['id']?>" title="Photo Gallery">
													    <img src="../assets/img/ico-photo.png" width="30" height="30"></a></td>
													  <td><?php echo  ($val['code'] != null) ? $val['code'] : '' ?></td>
													  <td><?php echo  ($val['price'] != null) ? number_format($val['price'],2) : '' ?></td>
													  <td><?php echo  ($val['discount'] != null) ? number_format($val['discount'],2) : '-' ?></td>
													  <td align="center"><input name="sequence_new[]" id="sequence_new" type="text" style="width:30px; text-align:center" maxlength="2" value="<?php echo $val['sequence'] ?>" align="absmiddle" /></td>
														...
														<td align="center">
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="product_edit.php?id=<?php echo  $val['id'] ?>&parent_id=<?php echo  $this->parent_id ?>&mn=6&sub=1">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																  <a class="red" href="product_action.php?id=<?php echo  $val['id'] ?>&do=delete&mn=6&sub=1" onClick="javascript:return confirm('Are you sure you want to delete this item ?')"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
															</div>
														</td>
													</tr>
  <?php } // foreach ?>
<?php } // if ?>
                          <!-- END LOOP -->
                                            ...
                                            <BR>
                                                <button class="btn btn-sm btn-success" type="button" onclick="location.href='product_add.php?mn=6&parent_id=<?php echo $this->parent_id ?>&menu=QmFubmVyIE1hbmFnZW1lbnQ'">
