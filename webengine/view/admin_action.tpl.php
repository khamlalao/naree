...
<meta http-equiv="refresh" content="<?php echo  ($this->redirect_delay != null) ? $this->redirect_delay : 0 ?>;URL=<?php echo  $this->url ?> ">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <h3 class="smaller lighter blue">อัพเดทข้อมูล รายชื่อเจ้าหน้าที่เรียบร้อย</h3>
									<?php // require_once($this->listitem); ?>
								</div>
