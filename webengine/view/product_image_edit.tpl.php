...
function checkForm(){
  with(document.form1){
	...
	<?php if($this->item->file_name == null){?>
    ...
    SetAction('product_image_action.php');
    //return true;
  }
}
...
<form class="form-horizontal" role="form" name="form1" id="form1" method="post" enctype="multipart/form-data" action="product_image_action.php">
<div class="tabbable">
											<div class="tab-content">
												<div id="thai" class="tab-pane fade in active">
													<!--<p>Raw denim you probably haven't heard of them jean shorts Austin.</p> -->
                                                    <h3 class="header smaller lighter blue">Product Gallery </h3>
                                        <BR>
  ...
  <tr>
    ...
    <a href="../../img_product_gallery/<?php echo  $this->item->file_name ?>" target="_blank"> <img src="../assets/img/ico-photo.png" width="30" height="30">  [<?php echo  $this->item->file_name ?>]</a><br />
	<?php } // if ?>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>Image JPG size width < 2000 px.</td>
  </tr>
    <tr>
    <td>Status &nbsp;: </td>
    <td>&nbsp;</td>
