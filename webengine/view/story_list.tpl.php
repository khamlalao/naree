  ...
  with(document.form1) {
    ...
    if (val == 'edit') {       
      if (chkstatus < 1) {   
        ...
        SetAction('story_edit.php?mn=2&id=' + chk_id); // edit last id.
      }                                        
    } else if (val == 'delete') {     
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction("story_action.php?do=listdelete"); 
      }                                            
    } else if (val == 'update') {                
      if (chkstatus < 1) {   
        alert("Please select any Check Box");     
        ...
        SetAction('story_action.php?do=listupdate');   
      }     
    } 
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td><?php echo  ($val['detail_en'] != null) ? substr($val['detail_en'],0,100) : '' ?></td>
														<td><?php echo  ($val['detail_la'] != null) ? substr($val['detail_la'],0,250) : '' ?></td>
														<td align="center">
                                                        <a href="../../img_story/<?php echo $val['file_name']?>" target="_blank"><img src="../../img_story/thumbnail/<?php echo $val['file_name']?>" alt=""/></a></td>
													  ...
													  <td><?php echo Lang::getStatus($val['status'])?></td>
														...
														<td align="center">
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="story_edit.php?id=<?php echo  $val['id'] ?>&mn=10&menu=c3RvcnkgTWFuYWdlbWVudA">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																  <a class="red" href="story_action.php?id=<?php echo  $val['id'] ?>&do=delete&mn=10&menu=c3RvcnkgTWFuYWdlbWVudA" onClick="javascript:return confirm('Are you sure you want to delete this item ?')"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
															</div>
														</td>
													</tr>
  <?php } // foreach ?>
<?php } // if ?>
                          <!-- END LOOP -->
                                            ...
                                            <BR>
                                            <button class="btn btn-sm btn-success" type="button" onclick="location.href='story_add.php?mn=10&menu=c3RvcnkgTWFuYWdlbWVudA'">
