			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content"><!-- /.page-header -->
						...
						<div class="row">
                        <form class="form-horizontal" role="form" name="form1" id="form1" method="post" enctype="multipart/form-data" action="lookbook_action.php">
                        <div class="tabbable">
											<div class="tab-content">
												<div id="thai" class="tab-pane fade in active">
													<!--<p>Raw denim you probably haven't heard of them jean shorts Austin.</p> -->
                                                    <h3 class="header smaller lighter blue">LOOKBOOK</h3>
                                        <BR>
    ...
    <td width="86%">&nbsp;</td>
										    ...
										    <tr>
										      ...
										      <td><?php if ($this->item->image != null) { ?>
										        <a href="../../img_lookbook/<?php echo  $this->item->image ?>" target="_blank"><img src="../../img_lookbook/thumbnail/<?php echo  $this->item->image ?>"/></a><br /><br />
										        <?php } // if ?>
										    ...
										    <tr>
										      <td>&nbsp;</td>
										      <td>&nbsp;</td>
										      <td height="30px">ไฟล์รูปภาพ JPG ขนาด 1180 x 218 px.</td>
									        </tr>
										    <tr>
										      <td>&nbsp;</td>
										      <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" id="end_date" name="end_date" value="" data-date-format="dd/mm/yyyy" class="date-picker col-xs-2" /></td>
                                        ...
                                        <input type="hidden" id="do" name="do" value="update" />
											...
											&nbsp; &nbsp; &nbsp;
											<button class="btn" type="button" onclick="location.href='lookbook_list.php?mn=4&sub=2'">
