				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h1><?php echo $this->promotion_category->subject_la?></h1>
						</div><!-- /.page-header -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
      ...
      <td><?php if ($this->item->file_doc != null) { ?>
        <a href="../../img_promotion/document/<?php echo $this->item->file_doc?>" target="_blank"><?php echo $this->item->file_doc?></a><br /><br />
        <?php } // if ?>
