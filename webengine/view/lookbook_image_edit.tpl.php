...
function checkForm(){
  with(document.form1){
    ...
    SetAction('lookbook_image_action.php');
    //return true;
  }
}
...
<form class="form-horizontal" role="form" name="form1" id="form1" method="post" enctype="multipart/form-data" action="lookbook_image_action.php">
<div class="tabbable">
											<div class="tab-content">
												<div id="thai" class="tab-pane fade in active">
													<!--<p>Raw denim you probably haven't heard of them jean shorts Austin.</p> -->
                                                    <h3 class="header smaller lighter blue">Lookbook Gallery </h3>
                                        <BR>
  ...
  <tr>
    ...
    <a href="../../img_lookbook_gallery/<?php echo  $this->item->file_name ?>" target="_blank"> <img src="../assets/img/ico-photo.png" width="30" height="30">  [<?php echo  $this->item->file_name ?>]</a><br />
	<?php } // if ?>
