...
<html lang="en">
	<head>
      ...
      <script language="javascript" type="text/javascript">
		function chkform(){
			//alert("sss");
			 SetAction('promotion_action.php?do=deletelist&mn=12&sub=2&menu=TmV3cw');
		}
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Promotion</h3>
                                        <BR>
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    ...
                                                    <tr>
														...
														<td><a href="../../img_promotion/banner/<?php echo $val['image']?>" target="_blank">
                                                        <img src="../../img_promotion/banner/<?php echo $val['image']?>" width="100"></a></td>
													  ...
													  <td><?php echo  ($val['update_date'] != null) ?  date('j/m/Y', strtotime($val['update_date'])) : date('j/m/Y') ?></td>
														...
														<td align="center">
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="promotion_edit.php?id=<?php echo  $val['id'] ?>&mn=12&sub=2">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																  <a class="red" href="promotion_action.php?id=<?php echo  $val['id'] ?>&do=delete&mn=12&sub=2" onClick="javascript:return confirm('Are you sure you want to delete this item ?')"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
															</div>
														</td>
													</tr>
  <?php } // foreach ?>
<?php } // if ?>
                          <!-- END LOOP -->
                                            ...
                                            <BR>
                                                <button class="btn btn-info" type="button" onclick="location.href='promotion_add.php?parent_id=<?php echo  $this->parent_id ?>&mn=12&sub=2'">
